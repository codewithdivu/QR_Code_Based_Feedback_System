...
const FeedbackQuestion2 = () => {
  return (
    ...
    <form action="">
        ...
        <div class="questions">
            ...
            <div>
                ...
                <label for="ques">Through a person known to a police officer </label>
        ...
        <div class="questions">
            ...
            <textarea name="" id="textarea" cols="27" rows="10" placeholder="Please describe your issue/problem."></textarea>
    ...
    <div class="police_btn"><button class="police_btn1">SUBMIT</button></div>
    </div>
  )
}
